...
class AbsenceApplications @Inject()(absenceApprove: AbsenceApproveService, protected val dbConfigProvider: DatabaseConfigProvider)
  ...
  private val JobTitleTable = TableQuery[TitleTableDef]
  private val JobPossitionTable = TableQuery[JobPositionDef]
    ...
    rs.map {
      list => {
        list.size match {
          ...
          case _ => {
            val itemLoad =
              new AbsenceApplicationsLoad(list.head._1._1._1._1.id, list.head._1._1._1._2.title, list.head._1._1._2.full_name, list.head._2.full_name, list.head._1._1._1._1.startTime, list.head._1._1._1._1.totalTime, list.head._1._1._1._1.status)
            val itemData = list.head._1._1._1._1
...
case class AbsenceRequestLoad(offset: Int, limit: Int, start: Int, writer: String, receiver: String, reasons: String, total: Float, ordervalue: Int, sortvalue: Int)
