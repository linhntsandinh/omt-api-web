          ...
          <CardBody>
            <Row>
              ...
              <Col >
                <Row>
                  <Col >
                    <Input className="lable_search" name="email" value={data.pr.state.email} onChange={(e) => data.pr.handleChange(e)}
                           onKeyPress={(ev, e) => {
                ...
                <Row>
                  <Col >
                    <Input className="lable_search" name="phone_number" value={data.pr.state.phone_number}
                ...
                <Row>
                  <Col >
                    <Input className="lable_search"  name="job_title" value={data.pr.state.job_title} onChange={(e) => data.pr.handleChange(e)}
                           onKeyPress={(ev, e) => {
                             console.log(`Pressed keyCode ${ev.key}`);
                             if (ev.key === 'Enter') {
                               document.getElementById("btn-search").click();
                  ...
                  <InputGroupAddon addonType="prepend">
                    <Button size="sm" onClick={(e) => {
                      if (this.state.search === true) {
                        this.setState({email: '', phone_number: '', job_title: ''})
                      }
            ...
            <Table responsive>
              ...
              <tbody>{
                this.state.data.map((user, index) =>
                  < FormCard key={index} user={user} stt={index + (this.state.check - 1) * this.state.limit + 1}/>)}
              </tbody>
            </Table>
            <Pagination  >
              <PaginationItem>
